  ...
  return (
    <main className="legal-page">
      <article className="legal-card">
        ...
        <p>
          SMS consent is a direct opt-in to Bur Oaks Campground only. Consent is not hidden inside a lease, payment authorization, AutoPay enrollment, portal account creation, camper directory listing, verbal conversation, or any other agreement. SMS consent is optional and is not required to stay at Bur Oaks Campground, use the camper portal, or receive campground services. Any enrolled number can reply STOP; a STOP reply turns off text alerts for the household profile.
        </p>
        <p>
