  ...
  return (
    <main className="legal-page">
      <article className="legal-card">
        ...
        <p>Event reminders are also a separate choice. Campers who RSVP <strong>Not Going</strong> to an event are excluded from that event’s automated reminders.</p>
