  ...
  return (
    <main className="legal-page">
      <article className="legal-card">
        ...
        <p>If you opt in to SMS text alerts, we use every valid mobile number saved in the primary, second-phone, or second-profile phone fields on the household profile to send non-marketing campground operational messages such as invoice notices and payment reminders for your site and any family site you are authorized to pay, account notices, maintenance updates, sewer pump-out updates, gate notices, utility notices, office notices, upcoming event reminders, safety notices, and weather-related operational alerts. Text Alerts include Wednesday reminders for events occurring within the next two weeks and a final event-day reminder. The camper enabling alerts confirms permission to enroll each saved household number. Any enrolled number can reply STOP to turn off only that number; the other saved numbers remain enrolled. If you separately opt in to personal greetings, we may also use your saved birthday, original camper date, email address, and opted-in phone number to send private birthday and annual camper-anniversary greetings.</p>
        ...
        <p>Campers opt in only after signing into the Bur Oaks Camper Portal. SMS consent is not collected through a lease, paper form, verbal conversation, directory setting, payment authorization, or bundled account agreement. The opt-in checkbox appears on the portal homepage and on the camper Profile and Invoices pages near the saved phone number and text-alert settings. A public explanation of the SMS consent process is available at <strong>www.buroakscampground.com/sms-consent</strong>.</p>
        <p>The checkbox states that by checking it, the camper agrees to receive SMS messages from Bur Oaks Campground about invoices, payment reminders, account notices, maintenance updates, sewer pump-out updates, gate notices, utility notices, office notices, upcoming event reminders, safety notices, weather-related operational alerts, and other non-marketing campground account or operations notices. The checkbox also states that Wednesday reminders may be sent for events within the next two weeks, message frequency varies, message and data rates may apply, campers can reply <strong>HELP</strong> for help, and campers can reply <strong>STOP</strong> to opt out.</p>
        ...
        <p>Event reminders are included with Text Alerts. Campers who RSVP <strong>Not Going</strong> to an event are excluded from that event’s automated reminders.</p>
