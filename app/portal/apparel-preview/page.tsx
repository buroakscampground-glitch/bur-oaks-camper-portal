...
const lightGarmentColors = new Set(['White', 'Cream', 'Heather', 'Gray', 'Light Gray', 'Sand', 'Khaki', 'Lake Blue'])
const darkGarmentColors = new Set(['Forest', 'Heather Green', 'Pine', 'Black', 'Charcoal', 'Navy', 'Burgundy', 'Vintage Green'])
...
const previewProducts: PreviewProduct[] = [
  {
    ...
    colors: [
      ...
      { name: 'White', value: '#f5f3ec' },
      { name: 'Heather', value: '#8b918d' },
      { name: 'Navy', value: '#263a4e' },
      { name: 'Burgundy', value: '#653943' },
  ...
  },
  {
    ...
    description: 'Comfortable fleece joggers with a script Bur Oaks wordmark running from the hip down the leg.',
    price: 44,
...
function garmentColorFilter(colorName: string) {
  const filters: Record<string, string> = {
    ...
    White: 'grayscale(.85) brightness(1.65) contrast(.78)',
    Heather: 'grayscale(.68) brightness(1.18) contrast(.88)',
    Gray: 'grayscale(.82) brightness(1.28) contrast(.86)',
    'Light Gray': 'grayscale(.8) brightness(1.42) contrast(.82)',
    ...
    Burgundy: 'hue-rotate(205deg) saturate(.72) brightness(.72)',
