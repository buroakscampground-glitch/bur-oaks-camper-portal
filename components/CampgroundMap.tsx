...
const satelliteEmbedUrl = `https://maps.google.com/maps?q=${encodedAddress}&t=k&z=17&output=embed`
  ...
  return (
    <div className={`campground-map ${compact ? 'compact' : ''}`}>
      <iframe
        ...
        title="Bur Oaks Campground satellite view"
      />
      ...
      <small className="campground-map-credit">Google satellite view</small>
    </div>
  )
}
